...
public class BattleUnitAnimationController
{
    ...
    private async UniTask Init(string id)
    {
        ...
        {
            Debug.Log($"{id} 애니메이션 못읽어옴");
            return;
        }

        Debug.Log(unitAnimationSet.IdleClip);
        _animatorOverrideController["Idle"] = unitAnimationSet.IdleClip;
        //_animatorOverrideController["Death"] = unitAnimationSet.DeathClip;
        //_animatorOverrideController["BasicAttack"] = unitAnimationSet.BasicAttackClip;
        //_animatorOverrideController["Signature"] = unitAnimationSet.SignatureClip;
    }
